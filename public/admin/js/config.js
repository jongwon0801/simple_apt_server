...
inspinia
  .config(function ($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
    ...
    $stateProvider.state("applebox.view", {
      url: "/RaspiView/:yid",
      templateUrl: "/admin/views/applebox/RaspiView.html",
      controller: "RaspiViewCtrl",
      authenticate: true,
      resolve: {
        loadCtrl: [
          "$ocLazyLoad",
          function ($ocLazyLoad) {
            return $ocLazyLoad.load("/admin/views/applebox/RaspiView.js");
          },
        ],
      },
    });
